...
public class PoseList_Base extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ListBox lb;
		lb = new ListBox(R.drawable.p_guide_1, "1번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "2번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "3번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "4번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "5번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "6번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "7번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "8번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "9번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "10번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "11번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "12번이 뭐지");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "13번이 뭐지");
		arlb.add(lb);
		...
		stCamera.setOnClickListener(new Button.OnClickListener(){
			...
			public void onClick(View arg0) {
				Intent stCIntent = new Intent(PoseList_Base.this, CameraActivity.class);
				stCIntent.putExtra("type", 0);
