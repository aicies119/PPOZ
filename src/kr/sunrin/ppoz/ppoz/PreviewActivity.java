...
public class PreviewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.pre_ok).setOnClickListener(new Button.OnClickListener() {
			@Override
		...
		findViewById(R.id.pre_cancel).setOnClickListener(new Button.OnClickListener() {
			@Override
			public void onClick(View v) {
				finish();
			}
	...
	public void pictureSave(byte[] data) {
		...
		try {
			...
			Toast.makeText(PreviewActivity.this, "파일 저장 중 에러 발생 : " + e.getMessage(), 0).show();
			return;
		}
