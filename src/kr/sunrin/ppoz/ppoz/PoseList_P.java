...
public class PoseList_P extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ListBox lb;
		lb = new ListBox(R.drawable.p_guide_1, "마이클 젝슨");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_2, "패션왕 셀카");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_3, "패션왕 셀카2");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_4, "싸이");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_5, "에비");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_6, "웨인루니자세");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_7, "조던");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_8, "당당이");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_9, "무용");
		arlb.add(lb);
		lb = new ListBox(R.drawable.p_guide_10, "좌절");
		arlb.add(lb);
		...
		stCamera.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent stCIntent = new Intent(PoseList_P.this,
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				convertView.setLayoutParams(new GridView.LayoutParams(
						displayWidth / 3, displayHeight / 4));
			}
