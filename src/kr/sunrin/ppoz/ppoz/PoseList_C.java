...
import kr.sunrin.ppoz.ppoz.PoseList_G.*;
...
public class PoseList_C extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ListBox lb;
		lb = new ListBox(R.drawable.c_guide_1, "열파참");
		arlb.add(lb);
		lb = new ListBox(R.drawable.c_guide_2, "다스베이더");
		arlb.add(lb);
		lb = new ListBox(R.drawable.c_guide_3, "천지창조");
		arlb.add(lb);
		lb = new ListBox(R.drawable.c_guide_4, "벽기대기");
		arlb.add(lb);
		lb = new ListBox(R.drawable.c_guide_5, "왈츠");
		arlb.add(lb);
		lb = new ListBox(R.drawable.c_guide_6, "퓨전");
		arlb.add(lb);
		lb = new ListBox(R.drawable.c_guide_7, "확 마!");
		arlb.add(lb);
		...
		stCamera.setOnClickListener(new Button.OnClickListener(){
			...
			public void onClick(View arg0) {
				Intent stCIntent = new Intent(PoseList_C.this, CameraActivity.class);
				stCIntent.putExtra("type", 2);
